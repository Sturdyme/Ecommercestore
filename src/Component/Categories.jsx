  ...
  transition-all divide-y divide-gray-400 duration-500 ${
    categories
      ...
      : "max-h-0 opacity-0"
        ...
        <Link to='/superdeals'> 
          <span className="text-black dark:text-white hover:text-purple-100 dark:hover:text-purple-200">Super Deals</span>
        </Link>
        ...
        <Link to='/homeappliances'> 
          <span className="text-black dark:text-white hover:text-purple-100 dark:hover:text-purple-200">Home Appliances</span>
        </Link>

        <li>
          <span className="text-black dark:text-white hover:text-purple-100 dark:hover:text-purple-200">Hair Extensions & Wigs</span>
        </li>

        <li className="flex gap-2 items-center sm:gap-1">
          <span className="text-black  dark:text-white hover:text-purple-100 dark:hover:text-purple-200">More</span>
