...
const Shopping = () => {
  return (
    <section className='p-8 mt-5'>
      <div className='bg-purple-400 rounded-lg flex justify-between items-center p-10 text-white w-full h-24'>
    ...
    <div> 
     <button className='bg-purple-800  text-white p-2 rounded-full font-serif hover:bg-pink-800  transition-colors
