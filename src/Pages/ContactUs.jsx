  ...
  return (
    <section>
      ...
      <div className="flex flex-col md:flex-row h-auto md:h-[500px] shadow-md overflow-hidden">
        ...
        {/* Image Section */}
        <div className="w-full text-black dark:text-white md:w-1/2 h-64 md:h-full">
          <img
            src={teamPic}
            alt="support-team"
        ...
        <div className="w-full md:w-1/2 bg-purple-500 flex items-start md:items-center">
          <div className="px-8 sm:px-12 md:px-16 py-8 md:py-0 mt-8 md:mt-0">
            ...
            {/* Heading */}
            <p className="text-xl sm:text-2xl font-thin text-black dark:text-white">
              We are Here To Help
            </p>
            ...
            <div className="mt-6">
              <button className="group flex items-center gap-2 bg-white text-purple-500 px-6 py-3 rounded-lg hover:bg-gray-200 transition-all duration-300 ease-in-out">
                Get In Touch
                <span className="transition-transform dark:text-purple-500 duration-500 group-hover:rotate-[360deg]">
                  <FaPaperPlane />
                </span>
              </button>
            </div>
